...
export const VoicePage: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-6xl">
      <h1 className="text-3xl font-bold mb-8" style={{ color: 'var(--color-text-primary)' }}>Voice Session</h1>
      ...
      <div className="space-y-6">
        {!isConnected ? (
          <div className="ds-card space-y-4">
            <h2 className="text-xl font-semibold" style={{ color: 'var(--color-text-primary)' }}>Start a Voice Session</h2>
            <AgentSelector
              value={selectedAgent}
          ...
          <>
            <div className="ds-card space-y-4">
              <div className="flex items-center justify-between">
                <h2 className="text-xl font-semibold" style={{ color: 'var(--color-text-primary)' }}>Active Session</h2>
                <VoiceControls
                  isConnected={isConnected}
                  isStarting={isStarting}
